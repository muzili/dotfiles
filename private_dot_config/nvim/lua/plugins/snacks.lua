return {
  ...
  keys = {
    ...
    { "<leader>/", function() 
      ...
      end, desc = "Grep (with word under cursor)" },
    ...
    -- LSP (keep only global navigation keys)
    ...
    -- Note: <leader>bd is handled by astrocore.lua for AstroNvim compatibility
    ...
    -- Neovim News
    {
      ...
      function()
        Snacks.win({
          ...
          width = 0.6,
          height = 0.6,
          wo = { wrap = false, spell = false, signcolumn = "yes", conceallevel = 3 },
        })
      end,
    },
